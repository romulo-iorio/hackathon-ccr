...
const CaminhaoCreateDB = fs.readFileSync(path.resolve(__dirname + '/SQLfiles/CaminhaoCreateDB.sql')).toString()
const CaminhaoInsert = fs.readFileSync(path.resolve(__dirname + '/SQLfiles/CaminhaoInsert.sql')).toString()
